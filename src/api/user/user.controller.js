...
function getAllUserHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, user_service_1.getAllUser)()];
                case 1:
                    users = _a.sent();
...
function createUserHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, user, emailData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = req.body;
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, user_service_1.createUser)(data)];
                case 2:
                    user = _a.sent();
                    emailData = {
                        ...
                        dynamicTemplateData: {
                            ...
                            url: "".concat(process.env.FRONTEND_URL, "Verify-account/").concat(user.passwordResetToken),
                        },
                    };
                    (0, email_1.sendMailSendGrid)(emailData);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, user_service_1.updateUser)(__assign(__assign({}, data), { id: id }))];
                case 2:
                    updatedUser = _a.sent();
