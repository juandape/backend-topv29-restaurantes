...
function getAllRestaurants() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.restaurants.findMany({
                        include: {
                            food: {
                                select: {
                                    id: true,
...
function getRestaurantById(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.restaurants.findUnique({
                        where: {
                            id: id,
                        },
                        include: {
...
function createRestaurant(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.restaurants.create({
                        data: data,
                    })];
                case 1:
                    restaurant = _a.sent();
...
function updateRestaurantById(id, data) {
    return __awaiter(this, void 0, void 0, function () {
        var updaterestaurant;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.restaurants.update({
                        where: { id: id },
                        data: data,
                    })];
                case 1:
                    updaterestaurant = _a.sent();
                    return [2 /*return*/, updaterestaurant];
            }
        });
    });
}
...
function deleteRestaurantById(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.restaurants.delete({
                        where: {
                            id: id,
                        },
                    })];
